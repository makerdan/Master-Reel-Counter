...
function PhotoCard({
  ...
  return (
    <div className={`rounded-md border bg-card overflow-hidden group relative flex flex-col ${isDetail ? "border-blue-600 ml-3" : "border-border"}`} data-testid={`strip-card-${photo.id}`}>
