    ...
    try {
      ...
      for (let pIdx = 0; pIdx < photoOrder.length; pIdx++) {
        ...
        try {
          ...
          if (data?.truncatedCount) totalSkippedPins += data.truncatedCount;
          succeededPhotos++;
        } catch (err: any) {
      ...
      if (anyTruncated) {
        const n = totalSkippedPins;
        toast({
          title: n > 0
            ? `${n} pin${n !== 1 ? "s" : ""} skipped — batch too large`
            : "Some pins were skipped — batch too large",
