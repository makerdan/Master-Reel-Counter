    ...
    return (
      ...
      >
        ...
        <div className="flex items-start gap-2 group" data-testid={`folder-header-${folder.id}`}>
          <Button variant="ghost" size="sm" className="gap-2 px-2 items-start h-auto" data-testid={`button-toggle-folder-${folder.id}`} title="Toggle folder" onClick={() => toggleFolderCollapse(folder.id)}>
