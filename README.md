...
- A **React + Vite** frontend (PWA-enabled) served in production with a registered service worker.
- An **Express.js** backend exposing RESTful and WebSocket endpoints.
- **PostgreSQL** as the backing database.
- **Replit Auth** and **Replit Object Storage** integrated for authentication and file storage.
